...
*difference() {
    diam = 10.0;
    cylinder(r = 11.5/2, h = 8, $fn = 128);
    translate([0, 0, 6]) cylinder(r = diam/2, h = 10, $fn = 128);
    translate([0, 0, 1.25]) metric_thread (diameter=diam, pitch=0.75, length=6, internal=true);
    translate([0, 0, 0]) cylinder(r = diam/2, h = 1.25, $fn = 128);
}
